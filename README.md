...
10 hand-written cases is too few for the ablations to be conclusive.
Expanding the dataset would test whether the 0.667 plateau is a real
model ceiling or an artifact of small-sample quantization.
